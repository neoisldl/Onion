...
use Onion\Error;
use Onion\HttpError;
use Onion\MVC\Router;
use Onion\MVC\Router_Abstract;
...
class Application {
    ...
    public static $support_method = array('HEAD', 'GET', 'POST', 'PUT', 'DELETE');

    /**
     * 路由器
     *
     * @var Onion\MVC\Router_Abstract
     * @access protected
     */
    protected $router;
     ...
     *
     * @access public
     * @return Onion\MVC\Router_Abstract
     */
