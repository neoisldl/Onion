<?php
namespace Onion\Utils;

use Onion\Error;
use Onion\Utils\Logging\IHandler;
...
class Logging {
    ...
    public function exception(\Exception $exception, $trace_limit = 0) {
        ...
        if ($exception instanceof \Onion\Error && function_exists('json_encode'))
        ...
        if ($prev_exception = $exception->getPrevious())
            $this->exception($prev_exception);
    }
    ...
    public static function getAllLogger() {
        return self::$logger;
    }
