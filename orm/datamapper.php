<?php
namespace Onion\DataMapper;

use Onion\Config;
use Onion\Error;
use Onion\IStorage;
use Onion\OrmError;
use Onion\Storage\Manager;
use Onion\Utils;
...
interface IData {
     ...
     * @static
     * @access public
     * @return Onion\DataMapper\Mapper
     */
...
abstract class Data implements IData {
    ...
    public static function getMetaDefine() {
        $meta = array(
...
abstract class Mapper {
     ...
     * @param mixed $id
     * @access public
     * @see \Onion\DataMapper\Data::find
     * @return Onion\DataMapper\Data
     */
...
class Meta {
     ...
     * 默认属性元数据定义数组
     */
    private static $default_prop_meta = array(
        'field' => NULL,            // 存储字段名
        'type' => NULL,             // 数据类型
