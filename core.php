...
namespace Onion {
    ...
    function autoload($class) {
        if (!in_namespace($class, 'Onion')) return false;
    ...
    if (!defined('Onion_NO_ERROR_HANDLER')){
        set_error_handler('\Onion\__on_error');
    }
    ...
    interface IStorage {
         ...
         * 构造函数
         * 参数都必须以数组方式传递
         * 这样才可以让Onion\Storage\Manager使用统一的初始化方法
         *
         * @param array $config
         * @access public
         * @return void
...
namespace Onion\Storage\DB {
    ...
    /**
     * 数据库连接类接口
     * 实现了此接口就可以在Onion内涉及数据库操作的类里通用
     *
     * @package DB
     * @author ldl <neoisldl@gmail.com>
     */
    interface IAdapter extends \Onion\IStorage {
        /**
         * 返回实际的数据库连接句柄
         *
         * @access public
         ...
         * @param mixed $bind
         * @access public
         * @return Onion\Storage\DB\IResult
         */
         ...
         * @access public
         * @return Onion\Storage\DB\Select
         */
