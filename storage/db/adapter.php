...
use Onion\Storage\DB\IAdapter;
use Onion\Storage\DB\IResult;
use Onion\Storage\DB\Select;
...
abstract class Adapter implements IAdapter {
    ...
    protected function connect() {
        ...
        if (!isset($options[\PDO::ATTR_STATEMENT_CLASS]))
            // 可以定义自己的result class
            $options[\PDO::ATTR_STATEMENT_CLASS] = array('\Onion\Storage\DB\Result');
    ...
    public function execute($sql, $bind = null) {
        ...
        if (DEBUG) {
            ...
            \Onion\logger('storage')->debug($log);
        }
