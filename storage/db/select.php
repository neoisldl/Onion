...
namespace Onion\Storage\DB {
    ...
    class Select {
        /**
         * get()方法返回的多行数据是否使用Onion\Utils\Set类包装
         * 影响到所有的实例
         *
         * @var boolean
         * @access public
         ...
         *
         * @access public
         * @return Onion\Storage\DB\IAdapter
         */
...
namespace Onion\Storage\DB\Select {
