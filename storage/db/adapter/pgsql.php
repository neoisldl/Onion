<?php
namespace Onion\Storage\DB\Adapter;

use Onion\Storage\DB;
use Onion\Storage\DB\Adapter;
use Onion\Storage\DB\Expr;
use Onion\Storage\DB\Select\Pgsql as Select;
...
class Pgsql extends Adapter {
    ...
    /**
     * 生成Onion\Storage\DB\Select\Pgsql实例
     *
     * @param string $table_name
     * @access public
     * @return Onion\Storage\DB\Select\Pgsql
     */
